	...
	public static void showToast(int status, Context context) {
		...
		case HttpContants.USER_NOTFOUND:
			Toast.makeText(context, context.getText(R.string.user_notfound),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.PHONE_ERROR:
			Toast.makeText(context, context.getText(R.string.phone_error),
					Toast.LENGTH_SHORT).show();
			break;
		...
		case HttpContants.USER_UNLOGIN:
			...
			((BasicActivity) context).finishSimple();
			break;
		case HttpContants.CODE_ERROR:
			Toast.makeText(context, context.getText(R.string.code_error),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.MAINUSER_DEL_ERROR:
			Toast.makeText(context,
					context.getText(R.string.mainuser_del_error),
					Toast.LENGTH_SHORT).show();
			break;
	...
	public static void showUserStatus(int status, Context context) {
		...
		case HttpContants.MODIFY_PSW_SUCCESS:// 修改密码成功
			Toast.makeText(context,
					...
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.GETTING_CODE:// 正在获取验证码
			Toast.makeText(context, context.getText(R.string.getting_code),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.WRONG_FORMAT:// 输入信息的格式有误
			Toast.makeText(context, context.getText(R.string.wrong_format),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.PHONE_FORMAT_ERROR:// 输入手机号的格式有误
			Toast.makeText(context,
					context.getText(R.string.phone_format_error),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.CODE_SUCCESS:// 获取验证码成功
			Toast.makeText(context, context.getText(R.string.code_success),
					Toast.LENGTH_SHORT).show();
			break;
	...
	public static void showMemberStatus(int stauts, Context context) {
		...
		case HttpContants.MODIFY_SUCCESS:// 修改成功
			Toast.makeText(context, context.getText(R.string.modify_success),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.UPLOAD_AVATAR_FAILED:// 上传头像失败
			Toast.makeText(context,
					context.getText(R.string.upload_avatar_failed),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.UPLOAD_AVATAR_SUCCESS:// 上传头像成功
			Toast.makeText(context,
					context.getText(R.string.upload_avatar_failed),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.UPLOAD_MAXCARD_FAILED:// 上传二维码失败
			Toast.makeText(context,
					context.getText(R.string.upload_avatar_failed),
					Toast.LENGTH_SHORT).show();
			break;
		case HttpContants.UPLOAD_MAXCARD_SUCCESS:// 上传二维码失败
			Toast.makeText(context,
					context.getText(R.string.upload_avatar_failed),
					Toast.LENGTH_SHORT).show();
			break;
		...
		case HttpContants.DEL_USER_SUCCESS:// 删除成员成功
			Toast.makeText(context, context.getText(R.string.del_user_success),
					Toast.LENGTH_SHORT).show();
			break;
		case SDCardNotFound://请插入sd卡上传头像
		    Toast.makeText(context, context.getText(R.string.sdcard_notfound),
                    Toast.LENGTH_SHORT).show();
		}
	}
